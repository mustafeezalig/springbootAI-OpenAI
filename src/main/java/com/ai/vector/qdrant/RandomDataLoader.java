...
public class RandomDataLoader {
	...
	public void loadSentencesIntoVectorStore() {
		...
		List<String> sentencnes=List.of("Java is used for building scalable enterprise applications.",
		...
		List<Document> documents=sentencnes.stream().map(Document::new).collect(Collectors.toList());
